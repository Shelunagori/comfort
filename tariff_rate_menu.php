...
<body class="fixed-top">
   ...
   <div class="page-container row-fluid">
     ...
     <?php temp(); ?>
		...
		{
							if(isset($_GET['tariff_view']))
							{
								?>  
                                    <div class="portlet box blue" >
                                    <div class="portlet-title">
                                    <h4><i class="icon-search"></i> Tariff Search</h4>
                                    </div>
                                    <div class="portlet-body form">
                                    <?php
							}
							else if(isset($_GET['tariff_delete']))
							{
                                    ?>
                                    <div class="portlet box red" >
                                    <div class="portlet-title">
                                    <h4><i class="icon-trash"></i> <i class="icon-ban-circle"></i> Tariff Delete</h4>
                                    </div>
                                    <div class="portlet-body form">
                                    <?php
							}
							else
							{
								?>
                                    ...
                                    <div class="portlet-title">
                                    <h4><i class="icon-edit"></i>Tariff Update</h4>
                                    </div>
                                    <div class="portlet-body form">
                                <?php
							}
					...
					?>
                         ...
                         <?php
							if(isset($_GET['tariff_view']))
							{
								?>
                                <td>
                                <a class="btn mini blue"  role="button"  href="view.php?tariff=true&id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
                            ...
                            <button type="button"  onClick="delete_tariff(<?php echo $idd; ?>,<?php echo $i; ?>);" id="refresh"    data-dismiss="modal"  class="btn red"><i class="icon-trash"></i> Delete</button>
                            </div>
                            </div>        
							...
							{
								?>
                                 <td><a class="btn mini red"  role="button"  href="update_tariff.php?id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;"><i class="icon-edit"></i></a>
                                </td>
                                 <?php
							}
		...
		else if(isset($_GET['mode']))
		{
			if($_GET['mode']=='edit')
			{
				?>
                        <div class="portlet box yellow" >
                        <div class="portlet-title">
                        <h4><i class="icon-edit"></i>Tariff Edit</h4>
                        </div>
                        <div class="portlet-body form">
                         <form action="tariff_rate_menu.php?tariff_edit=true" name="form_name" autocomplete="off" method="post">
			...
			else if($_GET['mode']=='del')
			{
				?>
                		<div class="portlet box red" >
                        <div class="portlet-title">
                        <h4><i class="icon-trash"></i>Tariff Delete</h4>
                        </div>
                        <div class="portlet-body form">
	                    <form action="tariff_rate_menu.php?tariff_delete=true" name="form_name" autocomplete="off" method="post">
                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                        <td>Service:</td>
                        <td> 
			...
			else if($_GET['mode']=='view')
			{
				?>
                        ...
                        <div class="portlet-body form">
	                    <form action="tariff_rate_menu.php?tariff_view=true" name="form_name" autocomplete="off" method="post">
                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                        <td>Service:</td>
                        <td> 
        ...
        <div class="portlet box blue">
        <div class="portlet-title">
        <h4><i class="icon-plus"></i>Tariff Rate</h4>
        </div>
        <div class="portlet-body form">
       ...
       <input type="text" name="rate" onKeyUp="allLetter(this.value,this.id)" id="rate" class="span6 m-wrap" />
        ...
        <button type="submit"   class="btn green" name="tariff_reg"/><i class="icon-ok"></i> Submit</button>
        </div>
        </div>
        </div> 
        </form>
