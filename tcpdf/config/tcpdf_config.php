...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	 ...
	 * header title
	 */
	define ('PDF_HEADER_TITLE', 'Comfort Travels & Tours');
	/**
	 * header description string
	 */
	define ('PDF_HEADER_STRING', '"Akruti", 4-New Fatehpura, Opp. Saheliyo ki Badi UDAIPUR-313004 Fax: +91-294-2422131 Mob. +91-294-2411661/62');
