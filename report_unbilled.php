...
<a class="btn blue diplaynone tooltips" role="button" href="report_unbilled.php"  title="Back" data-placement="bottom"><i class="icon-circle-arrow-left"></i></a>    
...
<input type="hidden" value="unbilled" name="excel_for">
</form>   
 <?php
	 }
	 ?>
	 ...
	 if(isset($_GET['mode']))
	 {
		 if($_GET['mode']=='view')
		 {
            ...
            <h4><i class="icon-eye-close"></i>Result for Unbilled DS</h4>
            </div>
	 ...
	 {
		 ?>
        <form  name="form_name" action="report_unbilled.php?mode=view" class="form-horizontal"  method="post">
        <div class="portlet box blue">
        <div class="portlet-title">
        <h4><i class="icon-eye-close"></i>Unbilled DS</h4>
        </div>
        <div class="portlet-body form">
