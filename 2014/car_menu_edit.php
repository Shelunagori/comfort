...
<a href="car_menu_edit.php" class="btn red"><i class="icon-edit"></i> Edit</a>
					...
					$qry="select * from car_reg where ";
                      ...
                      //  echo $sql;
                       ...
                       ?>
                            ...
                            <td><a class="btn mini red"  role="button"  href="update_car.php?id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
