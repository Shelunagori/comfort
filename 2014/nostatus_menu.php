   ...
   <div class="page-container row-fluid">
      ...
      <div class="page-content">
         <div class="container-fluid">
          <a class="btn green diplaynone" href="nostatus_menu_all.php"  role="button"  style="text-decoration:none; margin-top:1%;"><i class="icon-table"></i> View All</a>
           <?php
	...
	if(isset($_GET['mode']))
			...
			$mydatabase = new DataBaseConnect();
						$result= $mydatabase->execute_query_return("select * from `duty_slip`   where `customer_reg_name`='".$_POST['duty_slip_customer_reg_name']."' && `status`='no'  ORDER BY `current_date` ASC");
				$i=0;
						?>
						<table width="100%" align="center" border="1" cellpadding="0" cellspacing="0"  style="line-height:22px">
							 <thead><tr><td colspan="8" align="center"><b>Report of Unbilled DS. dated on <?php echo date("d-M-Y") ?></b></td></tr>  
						<tr>
						<th>Sr. No.</th>
						<th>Duty Slip</th>
						<th>Date</th>						
				...
				{
					?>
     <form method="post" action="nostatus_menu.php?mode=view" name="form_name">
               <table width="100%">
