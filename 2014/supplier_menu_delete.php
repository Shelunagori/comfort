...
<a href="supplier_menu_delete.php" class="btn red"><i class="icon-trash"></i> Delete</a>
    					...
    					<i class="icon-trash"></i></a>
                         <div style="display: none;" id="myModal1<?php echo $i ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
									...
									<button class="btn" data-dismiss="modal" aria-hidden="true">Cancel</button>	
                                     <a class="btn red" href='delete.php?delete_spplier=true&id=<?php echo $idd;?>'><i class="icon-trash">&nbsp;</i>Delete</a>
									</div>
									</div>
