...
<a href="tariff_rate_menu_delete.php" class="btn red"><i class="icon-trash"></i> Delete</a>
                     ...
                     $data_base_object = new DataBaseConnect();
                       ...
                       ?>
                            ...
                            <td><?php echo $extra_hour_rate;?></td>
                             <td><a class="btn mini red"  role="button"  href="delete.php?delete_tariff=true&id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
