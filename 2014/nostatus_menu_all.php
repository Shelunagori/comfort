   ...
   <div class="page-container row-fluid">
      ...
      <div class="page-content">
         <div class="container-fluid">
           <a class="btn green diplaynone"  role="button"  href="nostatus_menu.php" style="text-decoration:none; margin-top:1%;"><i class="icon-arrow-left"></i> Back</a>
          <a class="btn green diplaynone"  role="button"  href="javascript:window.print();" style="text-decoration:none; margin-top:1%;"><i class="icon-print"></i>Print</a>
           <a class="btn yellow diplaynone" target="_blank"  href="excel_all.php?&type=unbilled" style="text-decoration:none; margin-top:1%;"><i class="icon-download-alt"></i> Export in Excel</a>
     <?php menu(); ?>
    <?php
