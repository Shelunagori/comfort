...
<a href="booking_menu_search.php" class="btn red"><i class="icon-search"></i> Search</a>
</div> -->
<br />
     ...
     <tr><td> Travel Date From : </td><td><input type="text" id="dp1" name="travel_from"  class="m-wrap medium" /> </td></tr>
						 <tr><td> Travel Date To : </td><td><input type="text" id="dp2" name="travel_to" class="m-wrap medium"/>
                          <button type="submit" style="margin-left:1%;"  class="btn green" name="booking_edit" />Go <i class="icon-circle-arrow-right"></i></button></td></tr>
						 <tr><td></td><td>&nbsp;</td></tr>
						 </table>  <br>
					...
					if(strpos($sql, "where")==false)
					{
                       ...
                       ?>
                            ...
                            <td><?php echo $service_name;?></td>
                             <td><a class="btn mini red"  role="button"  href="view_booking.php?booking=true&id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
