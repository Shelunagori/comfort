...
<a href="supplier_tariff_rate_menu_delete.php" class="btn red"><i class="icon-trash"></i> Delete</a>
...
<br />
				...
				if(!empty($_POST['carname_master_id']))
				{
					...
					if($q1=="")
                     ...
                     <td><a class="btn mini red"  role="button"  href="delete.php?delete_supp_tariff=true&id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
