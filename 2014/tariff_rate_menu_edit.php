...
<a href="tariff_rate_menu_edit.php" class="btn red"><i class="icon-edit"></i> Edit</a>
                     ...
                     $data_base_object = new DataBaseConnect();
                       ...
                       ?>
                            ...
                            <td><?php echo $extra_hour_rate;?></td>
                             <td><a class="btn mini red"  role="button"  href="update_tariff_rate.php?id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
