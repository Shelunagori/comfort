...
<br />
                    ...
                    <div class="portlet-body form">
						 ...
						 <tr><td> Flight Number : </td><td>
                          <select name="flight_no"  class="chosen"  >
    							 <option value="" ></option>
    								    <?php
									  $database=new DataBaseConnect();
									$result=$database->execute_query_return("select distinct flight_no from booking");
									while($row= mysql_fetch_array($result))
									{
									 $flight_no = $row['flight_no'];
								   echo '<option value="'.$flight_no.'">'.$flight_no.'</option>';
									}
        				      ?>

     </select>
                          <button type="submit" style="margin-left:1%; margin-top:-4%"  class="btn green" name="booking_edit" />Go <i class="icon-circle-arrow-right"></i></button></td></tr>
						 <tr><td></td><td>&nbsp;</td></tr>
						 </table>  <br>
					...
					if(strpos($sql, "where")==false)
					{
                       ...
                       ?>
                            ...
                            <td><?php echo $service_name;?></td>
                             <td><a class="btn mini red"  role="button"  href="booking_update.php?id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
