...
<a href="customer_tariff_rate_menu_delete.php" class="btn red"><i class="icon-trash"></i> Delete</a>
					...
					if($q1=="")
                       ...
                       ?>
						  <tr>
                                ...
                                <td><a class="btn mini red"  role="button"  href="delete.php?delete_cust_tariff=true&id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
