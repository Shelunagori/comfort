...
<body class="fixed-top">
   ...
   <div class="page-container row-fluid">
     ...
     <?php temp(); ?>
		...
		{
							if(isset($_GET['supplier_tariff_rate_view']))
							{
								?>  
                                    <div class="portlet box blue" >
                                    <div class="portlet-title">
                                    <h4><i class="icon-search"></i> Supplier Tariff Search</h4>
                                    </div>
                                    <div class="portlet-body form">
                                    <?php
							}
							else if(isset($_GET['supplier_tariff_rate_delete']))
							{
                                    ?>
                                    <div class="portlet box red" >
                                    <div class="portlet-title">
                                    <h4><i class="icon-trash"></i> <i class="icon-ban-circle"></i> Supplier Tariff Delete</h4>
                                    </div>
                                    <div class="portlet-body form">
                                    <?php
							}
							else
							{
								?>
                                    ...
                                    <div class="portlet-title">
                                    <h4><i class="icon-edit"></i> Supplier Tariff Update</h4>
                                    </div>
                                    <div class="portlet-body form">
                                <?php
							}
                    ...
                    <?php
						...
						if($q1=="" && $q2=="")
						$sql="select * from supplier_tariff";
						else
						$sql=$qry.$q1.$q2;
                        ...
                        {$i++;
                        	$idd=$row['id'];
							$supplier_name=fetchsuppliername($row['supplier_id']);
					...
					?>
                         ...
                         <?php
							if(isset($_GET['supplier_tariff_rate_view']))
							{
								?>
                                <td>
                                <a class="btn mini blue"  role="button"  href="view.php?supplier_tariff_rate_view=true&id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;">
                            ...
                            <button type="button"  onClick="delete_supplier_tariff(<?php echo $idd; ?>,<?php echo $i; ?>);" id="refresh"    data-dismiss="modal"  class="btn red"><i class="icon-trash"></i> Delete</button>
                            </div>
                            </div>        
							...
							{
								?>
                                 <td><a class="btn mini red"  role="button"  href="update_supplier_tariff.php?id=<?php echo $idd;?>" target="_blank" style="text-decoration:none;"><i class="icon-edit"></i></a>
                                </td>
                                 <?php
							}
		...
		else if(isset($_GET['mode']))
		{
			if($_GET['mode']=='edit')
			{
				?>
                        ...
                        <div class="portlet-body form">
                         <form action="supplier_tariff_rate_menu.php?supplier_tariff_rate_edit=true" name="form_name" autocomplete="off" method="post">
                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                        <td>Supplier</td>
                        <td> 
                        <select name="supplier_id" class="chosen" >	
			...
			else if($_GET['mode']=='del')
			{
				?>
                		<div class="portlet box red" >
                        <div class="portlet-title">
                        <h4><i class="icon-trash"></i>Supplier Tariff Delete</h4>
                        </div>
                        <div class="portlet-body form">
	                   <form action="supplier_tariff_rate_menu.php?supplier_tariff_rate_delete=true" name="form_name" autocomplete="off" method="post">
                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                        <td>Supplier</td>
                        <td> 
			...
			else if($_GET['mode']=='view')
			{
				?>
                		<div class="portlet box blue" >
                        <div class="portlet-title">
                        <h4><i class="icon-search"></i>Supplier Tariff View</h4>
                        </div>
                        <div class="portlet-body form">
	                    <form action="supplier_tariff_rate_menu.php?supplier_tariff_rate_view=true" name="form_name" autocomplete="off" method="post">
                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                        <td>Supplier</td>
                        <td> 
        ...
        <div class="portlet box blue">
        <div class="portlet-title">
        <h4><i class="icon-plus"></i>Supplier Tariff Rate</h4>
        </div>
        <div class="portlet-body form">
       ...
       <input type="text" name="rate" onKeyUp="allLetter(this.value,this.id)" id="rate" class="span6 m-wrap" />
        ...
        <button type="submit"   class="btn green" name="supplier_tariff_reg"/><i class="icon-ok"></i> Submit</button>
        </div>
        </div>
        </div> 
        </form>
