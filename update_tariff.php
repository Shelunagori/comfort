...
$idd=$_GET['id'];
$sql="SELECT * from `tariff_rate` where `id`='".$idd."'";
   ...
   <div class="page-container row-fluid">
     ...
     <?php temp(); ?>
       ...
       <input type="text" name="rate" value="<?php echo $row_data['rate']; ?>" onKeyUp="allLetter(this.value,this.id)" id="rate" class="span6 m-wrap" />
        ...
        <button type="submit"  style="margin-left:25%" class="btn green" name="update_tariff"/><i class="icon-question-sign"></i> Save Change</button>
